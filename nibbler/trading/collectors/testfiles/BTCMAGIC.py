...
def BTC():
    ...
    try:
        ...
        pass
    print('BTC the database length is equal to :',result)
    print('BTC the csv length is equal to:', len(data))


    if result == 0 or result == None:
        
        print('====BTC DATABASE IS EMPTY TIME TO POPULATE=======')
    ...
    if result > len(data):
        print('somBTCing went wrong, database is somehow longer than the csv, deleting all')
        my_cursor = my_conn.cursor()
