...
def THETA():
    ...
    try:
        ...
        pass
    print('THETA the database length is equal to :',result)
    print('THETA the csv length is equal to:', len(data))


    if result == 0 or result == None:
        
        print('====THETA DATABASE IS EMPTY TIME TO POPULATE=======')
    ...
    if result > len(data):
        print('somTHETAing went wrong, database is somehow longer than the csv, deleting all')
        my_cursor = my_conn.cursor()
